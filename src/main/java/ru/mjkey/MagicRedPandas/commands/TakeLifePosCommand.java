...
public class TakeLifePosCommand implements CommandExecutor {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        Main.getInstance().getLocationManager().setTakeLifePos(player.getLocation());
        player.sendMessage(formatMessage("position-set").replace("%type%", "забора жизни"));
        return true;
    }
